...
public class ManagerDto extends BaseUserDto {
    ...
    @Builder
    public ManagerDto(UUID id, String username, String password, EmailDto email, LocalDateTime birthday, String firstName, String lastName, Number phoneNumber, Boolean isEnabled, LocalDateTime hiringDate, List<RestaurantDto> restaurant) {
